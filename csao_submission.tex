...
\subsection{SASRec Transformer Ablation}

Adding \texttt{sasrec\_score} as the 7th feature produced significant improvements across all evaluation metrics:
...
\subsection{Business Impact: AOV Uplift}
